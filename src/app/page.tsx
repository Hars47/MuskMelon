...
export default function Home() {
  ...
  return (
    <div className={`container mx-auto px-4 py-16 bg-[#dde0ab] ${poppins.className}`}>
      <section className="text-center mb-20">
        <AnimatedGlobe />
        <h1 className="text-6xl font-bold mb-6 text-green-900 tracking-tight">
          Smart Waste <span className="text-green-900">Connect</span>
        </h1>
        <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed mb-8">
        Be the change – join our mission for a cleaner, more efficient waste management system!
        </p>
        {!loggedIn ? (
  ...
  />
      ...
      <section className="bg-[#668ba4] p-10 rounded-3xl shadow-lg mb-20">
